...
export function FilterBar({
  ...
  function toggleShoeType(type: ShoeType) {
    ...
    posthog.capture("collection_filtered", { filter_type: "shoe_type", value: type, active: !activeShoeTypes.includes(type) });
  }
  ...
  function toggleMaterial(material: ShoeMaterial) {
    ...
    posthog.capture("collection_filtered", { filter_type: "material", value: material, active: !activeMaterials.includes(material) });
  }
